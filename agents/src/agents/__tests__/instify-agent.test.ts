/**
 * Tests for InstifyVoiceAgent
 */

import { describe, it, expect, beforeEach } from 'vitest';
import { InstifyVoiceAgent } from '../instify-agent.js';
import type { CustomerContext } from '@/types/agent.js';

describe('InstifyVoiceAgent', () => {
  let agent: InstifyVoiceAgent;
  const roomName = 'test-room-123';

  beforeEach(() => {
    agent = new InstifyVoiceAgent(roomName);
  });
  ...
  describe('constructor', () => {
    ...
    it('should initialize with customer context', () => {
      ...
      const agentWithContext = new InstifyVoiceAgent(roomName, customerContext);
  ...
  describe('getGreetingInstructions', () => {
    it('should return generic greeting when no customer context', () => {
      ...
      expect(greeting).toContain('Instify');
  ...
  describe('shouldEscalate', () => {
    ...
    it('should not escalate for normal messages', () => {
      const normalMessages = [
        ...
        'What features does Instify offer?',
