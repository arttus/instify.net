# Instify Deployment Guide

> **Step-by-step guide for deploying Instify to production**
...
git clone https://github.com/yourorg/instify.git
cd instify.net
...
GRANT CONNECT ON DATABASE instify TO readonly_user;
...
docker compose exec instify-web npm run db:migrate
```
...
This deployment guide ensures a smooth, secure, and maintainable production deployment of Instify.
