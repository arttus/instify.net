        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-3">
            <Button
              asChild
              variant="outline"
              className="glass-card border-primary/30 hover:bg-primary/5 group"
            >
              <a href="tel:+18449634740" className="flex items-center">
                <Phone className="mr-2 h-4 w-4 text-primary group-hover:animate-pulse" />
                <span className="font-semibold">(844) 963-4740</span>
              </a>
            </Button>
            <ThemeToggle />
            <Button
