...
# View logs
docker-compose -f docker-compose.prod.yml logs --tail=50 odeuo-web
```
...
cd /home/deploy/odeuo
./scripts/update-production.sh --restart odeuo-web
./scripts/update-production.sh --restart n8n
./scripts/update-production.sh --restart odeuo-web,n8n,redis
```

## 📊 Monitoring & Health Checks

### Health Check Endpoints
- **Main App:** https://odeuo.net/api/health
- **n8n:** https://n8n.odeuo.net/healthz
...
# Specific service
docker-compose -f docker-compose.prod.yml logs -f odeuo-web
...
Production environment variables are in `/home/deploy/odeuo/.env.production`
...
docker-compose -f docker-compose.prod.yml logs odeuo-web
...
docker exec odeuo-postgres-prod pg_isready -U odeuo

# Access database
docker exec -it odeuo-postgres-prod psql -U odeuo -d odeuo
```
