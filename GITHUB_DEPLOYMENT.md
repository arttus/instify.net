...
## Deploy Instify Platform directly from GitHub to DigitalOcean
...
curl -fsSL https://raw.githubusercontent.com/arttus/instify.net/main/deploy.sh -o deploy.sh
...
- Clones from `https://github.com/arttus/instify.net.git`
- Sets up deployment directory at `/home/deploy/instify`
...
Your Instify platform with Voice AI is now deployed and running on DigitalOcean!
